...
(* OASIS_START *)
(* DO NOT EDIT (digest: 1e76761ced7d137833fe9e37b015a0cd) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          homepage = None;
          synopsis = "Blog templates using Cow";
          description = None;
          categories = [];
            ...
            [
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Blog_template"; "Foundation"; "Date"; "Blog"];
                      lib_pack = true;
                      lib_internal_modules = [];
                      lib_findlib_parent = None;
                      lib_findlib_name = Some "cowabloga";
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "atom_fetch.ml"; });
               Executable
                 ({
                     cs_name = "cowabloga_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = [];
                     },
                   {
               ...
               Executable
                 ({
                   ...
                   {exec_custom = true; exec_main_is = "siteserve.ml"; })
            ];
          plugins =
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some " âú·c\136\026û2\135 ú%\129\155v";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
